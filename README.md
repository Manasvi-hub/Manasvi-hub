...
- **[SehatSe-App](https://github.com/Manasvi-hub/SehatSe-App):** A comprehensive food-delivery application platform.

## 🛠 Tech Stack

- **Languages:** Java, Python, JavaScript, TypeScript
- **Backend:** Django, Node.js, Express
- **AI/ML:** Machine Learning, Reinforcement Learning, Generative AI (LLMs), LangChain
- **Frontend:** React, Next.js, HTML/CSS
- **Tools & Platforms:** Git & GitHub, Antigravity, Vercel
